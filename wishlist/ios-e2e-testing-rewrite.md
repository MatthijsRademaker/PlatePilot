...
PlatePilot has migrated from a Vue.js/Quasar web frontend to a native iOS SwiftUI application. The existing E2E tests in `e2e-tests-web-legacy/` are written using Playwright and target the deprecated web frontend. These tests need to be rewritten to test the native iOS app.

## Current State

### Existing E2E Test Structure
- **Location**: `e2e-tests-web-legacy/`
...
1. Update `e2e-tests-web-legacy/README.md` or create `src/ios/PlatePilot/UITests/README.md`
...
- [ ] Legacy Playwright tests in `e2e-tests-web-legacy/` are removed or clearly marked as deprecated

## Related Files

### To Update
- `e2e-tests-web-legacy/README.md` - Update to reference iOS tests or mark as deprecated
...
### To Deprecate/Remove
- `e2e-tests-web-legacy/tests/*.spec.ts` - Playwright test files (after migration)
- `e2e-tests-web-legacy/fixtures/` - May need to adapt for iOS tests
- `e2e-tests-web-legacy/playwright.config.ts` - No longer needed
