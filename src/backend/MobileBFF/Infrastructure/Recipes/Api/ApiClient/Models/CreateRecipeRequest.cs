...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Infrastructure.RecipeApi.Client.Models.CreateRecipeRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Infrastructure.RecipeApi.Client.Models.CreateRecipeRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Infrastructure.RecipeApi.Client.Models.CreateRecipeRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Infrastructure.RecipeApi.Client.Models.CreateRecipeRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "cuisine", n => { Cuisine = n.GetGuidValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "directions", n => { Directions = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "ingredients", n => { Ingredients = n.GetCollectionOfPrimitiveValues<Guid?>()?.AsList(); } },
                { "mainIngredient", n => { MainIngredient = n.GetGuidValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteGuidValue("cuisine", Cuisine);
            writer.WriteStringValue("description", Description);
            writer.WriteCollectionOfPrimitiveValues<string>("directions", Directions);
            writer.WriteCollectionOfPrimitiveValues<Guid?>("ingredients", Ingredients);
            writer.WriteGuidValue("mainIngredient", MainIngredient);
