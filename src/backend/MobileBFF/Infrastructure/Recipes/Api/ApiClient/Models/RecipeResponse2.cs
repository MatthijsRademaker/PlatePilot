...
namespace Infrastructure.RecipeApi.Client.Models
{
    ...
    public partial class RecipeResponse2 : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Infrastructure.RecipeApi.Client.Models.Ingredient3>? Ingredients { get; set; }
#nullable restore
#else
        public List<global::Infrastructure.RecipeApi.Client.Models.Ingredient3> Ingredients { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Infrastructure.RecipeApi.Client.Models.RecipeResponse2"/> and sets the default values.
        /// </summary>
        public RecipeResponse2()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Infrastructure.RecipeApi.Client.Models.RecipeResponse2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Infrastructure.RecipeApi.Client.Models.RecipeResponse2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Infrastructure.RecipeApi.Client.Models.RecipeResponse2();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ingredients", n => { Ingredients = n.GetCollectionOfObjectValues<global::Infrastructure.RecipeApi.Client.Models.Ingredient3>(global::Infrastructure.RecipeApi.Client.Models.Ingredient3.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Infrastructure.RecipeApi.Client.Models.Ingredient3>("ingredients", Ingredients);
