  ...
  <div class="register-page">
    ...
    <div class="register-content">
      ...
      <header class="register-header">
        ...
        <h1 class="app-title">Join PlatePilot</h1>
        <p class="app-tagline">Start your meal planning journey</p>
      </header>
      ...
      <div class="form-card">
        ...
        <q-form @submit.prevent="handleRegister" class="register-form">
          ...
          <div class="input-group">
            <label class="input-label">Name <span class="optional">(optional)</span></label>
            <q-input
              v-model="name"
              type="text"
